...
export function applyEffectiveStatCaps(stats: PlayerStats): PlayerStats {
  ...
  stats.damageBonusI = Math.min(stats.damageBonusI, 300)
  stats.damageBonusII = Math.min(stats.damageBonusII, 250)
  stats.damageBonusIII = Math.min(stats.damageBonusIII, 200)
